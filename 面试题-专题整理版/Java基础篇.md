...
// TODO private < default < protect < public 
...
首先，从定义和实现的角度来说，接口只定义了方法签名，但是没有实现，实现类必须提供所有方法的实现**Java 8** 开始允许在接口中定义 **默认实现方法**，用 default 关键字修饰，但是**Object类方法不能定义为default**；抽象类可以包含抽象方法和具体方法，子类需要实现抽象方法，可以继承具体方法。
